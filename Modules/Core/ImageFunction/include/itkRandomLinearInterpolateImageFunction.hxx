 ...
 *
 *=========================================================================*/
#ifndef itkRandomLinearInterpolateImageFunction_hxx
#define itkRandomLinearInterpolateImageFunction_hxx
...
auto
RandomLinearInterpolateImageFunction<TInputImage, TCoordRep>::EvaluateUnoptimized(const ContinuousIndexType & index) const
  -> OutputType
{
...
template <typename TInputImage, typename TCoordRep>
void
RandomLinearInterpolateImageFunction<TInputImage, TCoordRep>::PrintSelf(std::ostream & os, Indent indent) const
{
